<?php
	...
	Class General{
		 ...
		 * @return string|null
		 *	null if the number of times to repeat the string is zero,
		 ...
		 * @return bool
		 *	true due to the error suppression on the mkdir call??
		 */
		 ...
		 *	true if $needle is found in any of the arrays contained within
		 *	$haystack.
		 *	false otherwise.
		 */
		 ...
		 *	true if the case of the values in the array should be ignored, false
		 *	otherwise.
		 * @return
		 ...
		 *	to true.
		 * @return void|array[]
		 *	return the array structure reflecting the input directory and satisfying
		 *	the input constraints or void if the input directory is not actually a
		 *	directory.
		 */
